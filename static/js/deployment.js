document.addEventListener("DOMContentLoaded", () => {
  ...
  const unitSearch = document.getElementById(
    "unitSearch"
  );
  ...
  const selectedUnitCard = document.getElementById(
    "selectedUnitCard"
  );

  const unitIdInput = document.getElementById(
    "unitId"
  );

  const clearSelectedUnit = document.getElementById(
    "clearSelectedUnit"
  );

  const deploymentForm = document.getElementById(
    "deploymentForm"
  );
